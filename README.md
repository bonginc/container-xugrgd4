...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xugrgd4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xugrgd4.containers.anotherwebservice.com/
...
```
git clone git@github.com:bonginc/container-xugrgd4.git
cd container-xugrgd4
```
...
```
docker attach container-xugrgd4
```
